...
> Примечание про данные: в ноутбуках и заданиях часто используются внешние источники или пути вида `/datasets/...`, поэтому датасеты могут отсутствовать в репозитории.
